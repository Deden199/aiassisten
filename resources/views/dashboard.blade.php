      ...
      <div @click.outside="openNew=false"
        ...
        <form class="mt-4 grid gap-4" action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <input type="file" name="file" accept=".pdf,.doc,.docx,.ppt,.pptx,.txt"
                 ...
                 placeholder="Upload a document (optional)">
          <textarea name="text" rows="6" placeholder="Or paste/type your text here (optional)"
                    class="mt-2 block w-full rounded-xl border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-violet-400"></textarea>
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div class="text-xs text-gray-500 sm:col-span-2">PDF/DOC/DOCX/PPT/PPTX/TXT up to 10MB, or paste your own text.</div>
          </div>
