...
return new class extends Migration {
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            // (opsional) cap plan & timestamp terakhir
    ...
    public function down(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('users', 'usage_requests')) $table->dropColumn('usage_requests');
            if (Schema::hasColumn('users', 'last_ai_used_at')) $table->dropColumn('last_ai_used_at');
        });
    }
};
